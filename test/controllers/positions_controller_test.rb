...
class PositionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create position" do
    assert_difference("Position.count") do
      post positions_url, params: { position: { event_id: @position.event_id, name: @position.name, vacant: @position.vacant } }
    end
  ...
  test "should update position" do
    patch position_url(@position), params: { position: { event_id: @position.event_id, name: @position.name, vacant: @position.vacant } }
